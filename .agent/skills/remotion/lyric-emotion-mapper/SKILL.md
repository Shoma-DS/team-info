...
```bash
python /Users/deguchishouma/team-info/.agent/skills/common/scripts/team_info_runtime.py run-remotion-python -- -u \
  /Users/deguchishouma/team-info/.agent/skills/remotion/lyric-emotion-mapper/scripts/transcribe_to_lrc.py \
  "<音源ファイルパス>" \
  --lyrics "<歌詞ファイルパス>" \
  --output "/Users/deguchishouma/team-info/Remotion/my-video/public/assets/<歌詞ファイル名と同名>.lrc" \
  --output-format lrc \
  --json /Users/deguchishouma/team-info/Remotion/my-video/public/assets/lyric_animation_data.json \
  --intro-label "(イントロ)" \
...
python /Users/deguchishouma/team-info/.agent/skills/common/scripts/team_info_runtime.py run-remotion-python -- -u \
  ...
  "<音源ファイルパス>" \
  --lyrics "<歌詞ファイルパス>" \
  --output "/Users/deguchishouma/team-info/Remotion/scripts/lyrics/<曲名>.srt" \
  --output-format srt \
  --intro-label "(イントロ)" \
  --intro-min-seconds 0.30 \
  --model medium \
...
python /Users/deguchishouma/team-info/.agent/skills/common/scripts/team_info_runtime.py run-remotion-python -- \
  /Users/deguchishouma/team-info/.agent/skills/remotion/lyric-emotion-mapper/scripts/validate_lrc.py \
  <出力LRCパス> \
  <歌詞テキストパス>
```
...
```bash
bash /Users/deguchishouma/team-info/Remotion/scripts/render_to_outputs.sh AcoRielLyricCover <出力ファイル名>.mp4
```
