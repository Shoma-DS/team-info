...
7. `npm --prefix /Users/deguchishouma/team-info/Remotion/my-video run lint` を実行する。
8. レンダリングは勝手に実行しない。必要な場合はユーザー承認を取るか、コピペ可能な `cd /Users/deguchishouma/team-info/Remotion/my-video && npx remotion render ... --output=/Users/deguchishouma/team-info/outputs/sleep_travel/renders/...` コマンドを提示する。
