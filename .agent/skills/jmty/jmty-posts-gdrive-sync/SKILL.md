...
## 実行コマンド
```bash
python /Users/deguchishouma/team-info/.agent/skills/jmty/jmty-posts-gdrive-sync/scripts/sync_jmty_posts_to_gdrive.py
```

## 引数でコピー先を変更する場合
```bash
python /Users/deguchishouma/team-info/.agent/skills/jmty/jmty-posts-gdrive-sync/scripts/sync_jmty_posts_to_gdrive.py "/destination/root/absolute/path"
```
