---
description: "shared-agent-assets コマンドを CEO 経由で起動する"
...
まず `AGENTS.md` を読み、`/shared-agent-assets` のルールを確認してください。
次に `.agent/skills/common/agent-org-ceo/SKILL.md` を読み込み、そのスキルとして動作してください。
CEO としてこの依頼を受け付け、`/shared-agent-assets` の意味に応じて必要な専門スキルへ委譲してください。
