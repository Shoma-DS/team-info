---
description: "tyoudoii-illust-fetcher コマンドを CEO 経由で起動する"
...
まず `AGENTS.md` を読み、`/tyoudoii-illust-fetcher` のルールを確認してください。
次に `.agent/skills/common/agent-org-ceo/SKILL.md` を読み込み、そのスキルとして動作してください。
CEO としてこの依頼を受け付け、`/tyoudoii-illust-fetcher` の意味に応じて必要な専門スキルへ委譲してください。
