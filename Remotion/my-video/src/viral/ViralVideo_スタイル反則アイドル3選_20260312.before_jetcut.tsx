...
const SCENE_TIMELINE: { from: number; to: number; src: string; motionType?: string; motionIntensity?: number }[] = [
  ...
  { from: 94,   to: 193,  src: staticFile(`viral/${TITLE}/materials/01_opening.png`), motionType: "zoom_in",  motionIntensity: 0.8 },
  { from: 193,  to: 319,  src: staticFile(`viral/${TITLE}/materials/02_s1_1.jpg`),   motionType: "zoom_in",  motionIntensity: 1.0 },
  { from: 319,  to: 404,  src: staticFile(`viral/${TITLE}/materials/02_s1_2.jpg`),   motionType: "pan_right", motionIntensity: 1.0 },
  { from: 404,  to: 612,  src: staticFile(`viral/${TITLE}/materials/02_s1_3.jpg`),   motionType: "zoom_out", motionIntensity: 0.8 },
  { from: 612,  to: 725,  src: staticFile(`viral/${TITLE}/materials/03_s2_1.jpg`),   motionType: "zoom_in",  motionIntensity: 1.0 },
  { from: 725,  to: 826,  src: staticFile(`viral/${TITLE}/materials/03_s2_2.jpg`),   motionType: "pan_left", motionIntensity: 1.0 },
  { from: 826,  to: 1019, src: staticFile(`viral/${TITLE}/materials/03_s2_3.jpg`),   motionType: "zoom_in",  motionIntensity: 0.8 },
  { from: 1019, to: 1186, src: staticFile(`viral/${TITLE}/materials/04_s3_1.jpg`),   motionType: "zoom_in",  motionIntensity: 1.2 },
  { from: 1186, to: 1297, src: staticFile(`viral/${TITLE}/materials/04_s3_2.jpg`),   motionType: "pan_right", motionIntensity: 1.0 },
  { from: 1297, to: 1521, src: staticFile(`viral/${TITLE}/materials/04_s3_3.jpg`),   motionType: "zoom_out", motionIntensity: 0.8 },
  { from: 1521, to: 1566, src: staticFile(`viral/${TITLE}/materials/99_cta.png`),    motionType: "zoom_in",  motionIntensity: 0.5 },
];

// パターンインタラプト (3s=90f, 21.4s=643f, 35.8s=1074f)
const INTERRUPT_FRAMES: number[] = [90, 612, 1019];
