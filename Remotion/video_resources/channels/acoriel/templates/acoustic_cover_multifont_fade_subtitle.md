...
## 素材運用
- 音源: `Remotion/video_resources/channels/acoriel/assets/songs/`
- 背景: `Remotion/video_resources/channels/acoriel/assets/backgrounds/`
- 効果: `Remotion/video_resources/channels/acoriel/effects/templates/銀粒子_低刺激リリック.md`
- 歌詞LRC: `Remotion/my-video/public/assets/LOVE PHANTOM.lrc`（必要に応じて更新）

## 反映先
- `Remotion/my-video/src/AcoRielCover.tsx`
- `Remotion/my-video/src/AcoRielLyricCover.tsx`
- `Remotion/my-video/public/assets/lyric_animation_data.json`
