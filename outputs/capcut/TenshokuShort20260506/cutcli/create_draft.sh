...
set -euo pipefail
CUTCLI_DIR="C:/Users/abc_p/OneDrive/デスクトップ/teaminfo/outputs/capcut/TenshokuShort20260506/cutcli"
...
cutcli captions add "$DRAFT_ID" --captions "@$CUTCLI_DIR/captions.json" --font-size 8 --bold --text-color "#FFFFFF"
